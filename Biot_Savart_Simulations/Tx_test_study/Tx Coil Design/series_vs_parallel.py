        ...
        for config_name, L_eq, num_groups, turns_used in connection_cases:
            for f in freq_values:
                ...
                if config_name == "series":
                    ...
                    i_layer = irms / 2  # 2 parallel branches
...
# Ensure numeric
numeric_cols = ["n_turns", "B", "L", "frequency", "height", "voltage"]
