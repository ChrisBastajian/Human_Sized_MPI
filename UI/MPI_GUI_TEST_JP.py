...
class App(ctk.CTk):
    def __init__(self, *args, **kwargs):
        ...
        self.arduino1_serial_port    = "COM4"
        ...
        self.operating_modes = {
            ...
            "Mode 3 - 10 kHz": {"freq": 10000, "impedance": 3},
            "Mode 4 - 20 kHz": {"freq": 20000, "impedance": 4},
            "Mode 5 - 50 kHz": {"freq": 50000, "impedance": 5},
            "Mode 6 - 100 kHz": {"freq": 100000, "impedance": 6},
        }
        ...
        # Frequency
        ctk.CTkLabel(left, text="Operating Mode", font=F(13)
                     ).grid(row=11, column=0, padx=8, pady=3, sticky="e")

        self.operating_mode_dropdown = ctk.CTkOptionMenu(
            left,
            values=list(self.operating_modes.keys()),
            font=F(13),
        )

        self.operating_mode_dropdown.grid(row=11, column=1, padx=8, pady=3, sticky="ew")
    ...
    def run_steppers(self):
        ser = serial.Serial(self.arduino1_serial_port, 9600, timeout=1)
        time.sleep(2)
    ...
    def save_tx_parameters(self):
        ...
        current_operating_mode = self.operating_mode_dropdown.get()
        mode = self.operating_modes[current_operating_mode]              #Save Frequency Mode selection
        z_index = mode["impedance"]
        self.tx_frequency = mode["freq"]
        ...
        # ---- SEND MODE TO ARDUINO HERE ----

        self.set_impedance(z_index)
